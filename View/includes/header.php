<header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
        ...
        <div class="m-header">
            ...
            <a href="#!" class="b-brand">
                ...
                <img src="assets/images/admin_logo/logo-white.png" alt="" class="logo" width="100px">
                <img src="assets/images/admin_logo/logo-white.png" alt="" class="logo-thumb" width="40%">
            </a>
                ...
                <li>
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            <div class="pro-head">
                                <img src="assets/images/admin_logo/logo-white.png" class="img-radius" alt="User-Profile-Image">
                                <span>Admin</span>
                                <a href="#" class="dud-logout" title="Logout">
                                    <i class="feather icon-log-out " data-toggle="modal" data-target="#logOut" ></i>
                                </a>
                            </div>
                            <ul class="pro-body">
                                <!-- <li><a href="editProfile.php" class="dropdown-item"><i class="feather icon-user"></i> Profile</a></li> -->

                                <li><a href="settings.php" class="dropdown-item"><i class="feather icon-lock"></i> Settings</a></li>
                        </div>
                    </div>
                </li>
            </ul>
